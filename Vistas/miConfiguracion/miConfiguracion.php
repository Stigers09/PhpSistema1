...
<head>
	...
	<title>Nubecitas de colores</title>
        <link rel="stylesheet" type="text/css" href="<?php media(); ?>css/parteEdwin/css/normalize.css">
	<link rel="stylesheet" type="text/css" href="<?php media(); ?>css/parteEdwin/css/tienda_NB_css.css">	
...
<body>
	<header>		
		<a href="tienda.jsp">
			<img src="<?php media(); ?>/images/Logo.PNG" alt="Nubecitas de Colores">
		</a>		
